    ...
    >
      <>
              ...
              return (
                <button
                  ...
                  className={[
                    ...
                    isActive
                      ? "bg-gradient-to-r from-teal-500/10 to-cyan-500/10 text-teal-400 shadow-lg shadow-teal-500/10 scale-105"
        ...
        <div className="mt-auto px-4 pb-6 space-y-4">
          ...
          <div className="bg-slate-800/40 backdrop-blur-xl rounded-2xl p-4 border border-slate-700/50 shadow-xl hover:shadow-2xl hover:border-slate-600/50 transition-all duration-300 hover:scale-105 cursor-pointer">
            ...
            <button className="flex items-center justify-center gap-2 w-full px-3 py-2 rounded-lg bg-slate-900/50 hover:bg-slate-900 text-slate-300 hover:text-white text-xs font-medium transition-all duration-300 border border-slate-700/50 hover:border-slate-600 hover:scale-105 active:scale-95">
